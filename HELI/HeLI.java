...
// global table holding the language models for all the languages
	...
	public static Table<String, String, Double> gramDictCap;
	public static Table<String, String, Double> gramDictLow;
	public static Table<String, String, Double> wordDictCap;
	public static Table<String, String, Double> wordDictLow;
	public static String address = "/home/nianheng/Documents/dmt/n=8_p=3.87_+iteration/";
	public static adaptation toAdaptation = new adaptation();
...
// They set the number of units to read from each model file
	...
	public static double usedlow1gram = 1000;
	public static double usedlow2gram = 1000;
	public static double usedlow3gram = 1000;
	public static double usedlow4gram = 1000;
	public static double usedlow5gram = 1000;
	public static double usedlow6gram = 1000;
	public static double usedlow7gram = 1000;
	public static double usedlow8gram = 1000;

	public static double usedcap1gram = 1000;
	public static double usedcap2gram = 1000;
	public static double usedcap3gram = 1000;
	public static double usedcap4gram = 1000;
	public static double usedcap5gram = 1000;
	public static double usedcap6gram = 1000;
	public static double usedcap7gram = 1000;
	public static double usedcap8gram = 1000;

	public static double usedcapwords = 1000;

	public static double usedlowwords = 1000;

// this is the penalty value for unseen tokens

	public static double penalty = 3.87;
...
// This is the maximum length of used character n-grams (setting them to 0 gives the same outcome, but the identifier still divides the words)
	...
	public static int maximumlength = 8;
...
// We read the file languagelist which includes list of the languages to be included in the repertoire of the language identifier. You can use "ls -la Models/ | egrep 'Model' | gawk '{print $9}' | sed 's/\..*//' | sort | uniq > languagelist" to include all the languages which have models in the Models directory.
		...
		File file = new File(address + "languagelist");
...
//		File testfile = new File("./Test/test.txt");
		...
		// File testfile = new File("./Test/test.txt");
		File testfile = new File(address + "Test/test.txt");
		...
		try {
			...
			while ((testline = testfilereader.readLine()) != null) {
				...
				String identifiedLanguage = identifyText(mysterytext, count, true)[0];
				count = count + 1;
				//System.out.println(testline + "\t" + identifiedLanguage);
				//System.out.println("");
			}
			toAdaptation.anAdaptation();
	...
	public static void loadIn(double cutoff, String language, String tokentype) {
		...
		nextmodel = address + "Models/" + language + "." + tokentype;
...
// identifyText
	...
	public static String[] identifyText(String mysteryText, int count, boolean doAdaptation) {
...
//some extra characters included as alphabetical characters
		...
		Double guoyuScore = 0.0;
		Double mandarinScore = 0.0;
		...
		while(languageiterator.hasNext()) {
			...
			if (((String) element).equals("guoyu")){
				guoyuScore = languagescores.get(element);
			}
			else if (((String) element).equals("mandarin")) {
				mandarinScore = languagescores.get(element);
			}
			//System.out.println((String) element + " " + languagescores.get(element));
		}
		if (doAdaptation) {
			toAdaptation.addSentence(mysteryText, mysterylanguage, guoyuScore, mandarinScore, count);
		}
		return new String[] {mysterylanguage, guoyuScore.toString(), mandarinScore.toString()};
	}
}
